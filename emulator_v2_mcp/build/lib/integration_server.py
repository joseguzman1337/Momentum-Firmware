...
class EmulatorV2MCPServer:
    ...
    def _native_rpc(self, run_id: str, operation: str, path: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"run_id": run_id, "operation": operation, "endpoint": endpoint, "response_bytes": len(response), "response_base64": base64.b64encode(response).decode(), "canonical_native_transport": True}
        finally:
            os.close(fd)
